...
from mypalletizer_interfaces.srv import SetAngles, SetCoords, GripperStatus, GetCoords, GetAngles, PumpStatus
...
class TeleopKeyboardNode(Node):
    ...
    def __init__(self):
        ...
        self.init_pose = [0.0, 0.0, 0.0, 0.0]
