...
from mypalletizer_interfaces.msg import (
    MypalAngles,
    MypalCoords,
    MypalSetAngles,
    MypalSetCoords,
...
# from pyMypal.Mypal import Mypal
...
class MypalTopics(Node):
    def __init__(self):
        super().__init__("Mypal_topics")
    ...
    def pub_real_angles(self):
        pub = self.create_publisher(
            topic="Mypal/angles_real",
            msg_type=MypalAngles,
            qos_profile=5
        )
        ma = MypalAngles()
        while rclpy.ok():
    ...
    def pub_real_coords(self):
        pub = self.create_publisher(
            topic="Mypal/coords_real",
            msg_type=MypalCoords,
            qos_profile=5
        )
        ma = MypalCoords()
    ...
    def sub_set_angles(self):
        ...
        sub = self.create_subscription(
            topic="Mypal/angles_goal",
            msg_type=MypalSetAngles,
            callback=callback,
            qos_profile=1
        )
        rclpy.spin(sub)
    ...
    def sub_set_coords(self):
        ...
        sub = self.create_subscription(
            topic="Mypal/coords_goal",
            msg_type=MypalSetCoords,
            callback=callback,
            qos_profile=1
        )
        rclpy.spin(sub)
    ...
    def sub_gripper_status(self):
        ...
        sub = self.create_subscription(
            topic="Mypal/gripper_status",
            msg_type=MypalGripperStatus,
            callback=callback,
            qos_profile=1
        )
        rclpy.spin(sub)
    ...
    def sub_pump_status(self):
        ...
        sub = self.create_subscription(
            topic="Mypal/pump_status",
            msg_type=MypalPumpStatus,
            callback=callback,
            qos_profile=1
        )
        rclpy.spin(sub)
