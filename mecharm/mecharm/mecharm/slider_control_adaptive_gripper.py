...
class Slider_Subscriber(Node):
    """ROS2 node that subscribes to joint_states and controls MechArm270 in real-time."""
    ...
    def __init__(self):
        ...
        self.mc = MechArm270(port, 115200)
        time.sleep(0.05)
    ...
    def _send_loop(self):
        ...
        while True:
            ...
            if self.angles_queue:
                self.mc.send_angles(self.angles_queue, 25, _async=True)
                self.angles_queue = None
