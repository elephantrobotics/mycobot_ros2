...
def main(args=None):
    ...
    mecharm_services = Mycobot_Service()
    mecharm_services.output_robot_message()
    mecharm_services.create_services()
    rclpy.spin(mecharm_services)
    mecharm_services.get_logger().info("结束")
    rclpy.shutdown()
