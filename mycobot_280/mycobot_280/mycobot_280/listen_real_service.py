...
class MyCobotDriver(Node):
    def __init__(self):
        ...
        self.srv_angles = self.create_service(SetAngles, 'set_angles', self.set_angles_callback)  # set angles service
        self.srv_coords = self.create_service(SetCoords, 'set_coords', self.set_coords_callback)  # set coords service
        self.srv_get_coords = self.create_service(GetCoords, 'get_coords', self.get_coords_callback)  # get coords service
        self.srv_get_angles = self.create_service(GetAngles, 'get_angles', self.get_angles_callback)  # get angles service
        self.srv_gripper = self.create_service(GripperStatus, 'set_gripper', self.set_gripper_callback)  # gripper control service
        self.srv_pump = self.create_service(PumpStatus, 'set_pump_status', self.set_pump_callback)  # pump control service
