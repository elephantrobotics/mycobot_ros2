...
def generate_launch_description():
    moveit_config = MoveItConfigsBuilder("firefighter", package_name="mycobotpro630_gazeboros2").to_moveit_configs()
    ...
    spawn_entity = Node(
        ...
        arguments=['-topic', 'robot_description', '-entity', 'mycobotpro630'],
        output='screen'
    )
