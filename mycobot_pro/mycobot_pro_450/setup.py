...
setup(
    ...
    entry_points={
        'console_scripts': [
            'camera_display = mycobot_pro_450.camera_display:main',
            'follow_display = mycobot_pro_450.follow_display:main',
            'listen_real_of_topic = mycobot_pro_450.listen_real_of_topic:main',
            'listen_real = mycobot_pro_450.listen_real:main',
            'simple_gui = mycobot_pro_450.simple_gui:main',
            'slider_control = mycobot_pro_450.slider_control:main',
