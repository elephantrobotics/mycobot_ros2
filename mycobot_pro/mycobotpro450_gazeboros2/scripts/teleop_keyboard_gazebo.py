...
# -*- coding: utf-8 -*-
"""
MyCobot Pro 450 Teleop Keyboard Controller (ROS 2)
Controls Gazebo simulation and optionally real Pro450 arm.
"""
...
class TeleopKeyboard(Node):
    ...
    def initialize_pro450(self):
        ...
        try:
            ...
            self.get_logger().info("Pro450 connected OK")
            return True
        ...
        while self.executor_running and rclpy.ok():
            ...
            if arm_cmd is not None:
                ...
                if self.mc is not None:
                    try:
                        self.mc.send_angles(arm_cmd, ROBOT_SPEED)
                    except Exception:
                        pass
            ...
            if gripper_cmd is not None:
                ...
                if self.mc is not None:
                    try:
                        ...
                        self.mc.set_pro_gripper_angle(ga, GRIPPER_ID)
                    except Exception:
                        pass
...
def main(args=None):
    ...
    print("=== MyCobot Pro 450 Teleop Keyboard (ROS 2) ===")
